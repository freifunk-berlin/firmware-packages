...
if has_wan then
	...
	local share = f:field(Flag, "sharenet", "Eigenen Internetzugang freigeben", "Geben Sie Ihren Internetzugang im Freifunknetz frei.")
	share.rmempty = false
...
if has_l2gvpn then
	...
	local gvpnip = f:field(Value, "gvpnipaddr", translate("IPv4-Address"))
